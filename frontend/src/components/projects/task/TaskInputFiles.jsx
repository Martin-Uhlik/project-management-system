...
export const TaskInputFiles = () => {
    ...
    useEffect(() => {
        axios.get(getBackendAddress(`/auth/projects/${projectID}/tasks/${taskID}/input-files`),
            getAuthHeader())
        .then((response) => {
    ...
    const handleUploadFile = (event) => {
        ...
        axios.post(getBackendAddress(`/auth/projects/${projectID}/tasks/${taskID}/input-files`),
            data,
            {
                headers: {
